...
if (isset($_POST["username"]) && isset($_POST["password"])) {
    ...
    $consulta_select_login = "SELECT * FROM usuarios WHERE `usuario`='$username' AND `clave`='$password' LIMIT 1";
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Nombre de usuario:
                      </label>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">¡Por favor, introduzca su contraseña!
                      </div>
                    </div>
