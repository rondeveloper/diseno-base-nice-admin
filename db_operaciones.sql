...
-- Tiempo de generación: 08-04-2022 a las 19:55:14
...
INSERT INTO `personal` (`id`, `nombre`, `cargo`, `telefono`, `email`, `direccion`, `estado`) VALUES
(1, 'ron', 1, '55555533', 'ron@gmail.com', 'Central 123', 1);
...
INSERT INTO `usuarios` (`id`, `id_personal`, `usuario`, `clave`, `tipo`) VALUES
(2, 1, 'ron', 'apisoft', 1);
